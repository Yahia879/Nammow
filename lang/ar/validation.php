...
ظور.',
    ...
    */
    ...
    'attributes' => [
        ...
        'new_leave_type_id' => 'نوع الإجازة',
        'new_start_date' => 'تاريخ بدء الإجازة',
        'new_end_date' => 'تاريخ انتهاء الإجازة',
        'new_reason' => 'السبب',
        'rejection_reason' => 'سبب الرفض',
        'client_id_form' => 'العميل',
        'selected_companies' => 'الشركات المختارة',
    ],
];
